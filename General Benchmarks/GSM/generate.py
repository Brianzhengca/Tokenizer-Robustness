...
normal_output_file = open("normal_gsm_outputs.txt", "w")
perturbed_output_file = open("perturbed_gsm_outputs.txt", "w")
normal_responses, perturbed_responses = interface.generate_response(lines, max_new_tokens=2048, batch_size=10)
