...
PROMPTS = {
    ...
    "del_char": 'Delete every instance of a specified letter in a given word (Do not generate code), based on the following examples:\n\
            \n\
    ...
    "del_word": 'Delete every instance of a specified word in a given sentence, based on the following examples:\n\
            ...
            \n\
            Question: Delete every instance of "{}" in "{}".',
    "swap_char": 'Swap the positions of two specified letters in a given word (Do not generate code), based on the following examples:\n\
            \n\
